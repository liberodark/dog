...
mod test {
    ...
    fn parses_non_critical() {
        ...
        assert_eq!(
            CAA::read(buf.len() as _, &mut Cursor::new(buf)).unwrap(),
            CAA {
                critical: false,
    ...
    #[test]
    fn record_empty() {
        assert_eq!(CAA::read(0, &mut Cursor::new(&[])), Err(WireError::IO));
    }
    ...
    fn buffer_ends_abruptly() {
        ...
        assert_eq!(CAA::read(23, &mut Cursor::new(buf)), Err(WireError::IO));
    }
}
