    ...
    fn read(stated_length: u16, c: &mut Cursor<&[u8]>) -> Result<Self, WireError> {
        ...
        if stated_length == total_length {
            ...
            Err(WireError::WrongLabelLength {
                stated_length,
                length_after_labels: total_length,
            })
        }
    }
}
...
mod test {
    ...
    fn parses_one_iteration() {
        ...
        assert_eq!(
            TXT::read(buf.len() as _, &mut Cursor::new(buf)).unwrap(),
            TXT {
    ...
    fn parses_two_iterations() {
        let buf = &[
            ...
            0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41,
            0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41,
            0x41, 0x41, 0x41, // exactly two hundred and fifty five ‘A’s (screaming)
    ...
    fn right_at_the_limit() {
        let buf = &[
            ...
            0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42,
            0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42,
            0x42, 0x42, // exactly two hundred and fifty four ‘B’s (a hive)
        ];
    ...
    fn another_message() {
        ...
        assert_eq!(
            TXT::read(buf.len() as _, &mut Cursor::new(buf)).unwrap(),
            TXT {
                messages: vec![Box::new(*b"txt me"), Box::new(*b"ya beb"),],
            }
        );
    }
    ...
    #[test]
    fn record_empty() {
        assert_eq!(TXT::read(0, &mut Cursor::new(&[])), Err(WireError::IO));
    }
    ...
    fn buffer_ends_abruptly() {
        ...
        assert_eq!(TXT::read(23, &mut Cursor::new(buf)), Err(WireError::IO));
    }
}
