...
mod test {
    ...
    fn parses() {
        ...
        assert_eq!(
            A::read(buf.len() as _, &mut Cursor::new(buf)).unwrap(),
            A {
    ...
    fn record_too_short() {
        ...
        assert_eq!(
            A::read(buf.len() as _, &mut Cursor::new(buf)),
    ...
    fn buffer_ends_abruptly() {
        ...
        assert_eq!(A::read(4, &mut Cursor::new(buf)), Err(WireError::IO));
    }
}
