...
use dns::record::{A, CNAME, OPT, Record, RecordType, SOA, UnknownQtype};
use dns::{Answer, Flags, Labels, Opcode, QClass, Query, Response};
...
fn parse_response_with_mixed_string() {
    let buf = &[
        ...
        0x6c, 0x6f, 0x6f, 0x6b, 0x75, 0x70, 0x03, 0x64, 0x6f, 0x67,
        0x00, // "cname-example.lookup.dog"
